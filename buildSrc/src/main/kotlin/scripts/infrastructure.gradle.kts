...
tasks.register("compileApp") {
    description = "Compiles Android Client."
...
tasks.register("runApp", Exec::class) {
    ...
    if (localProperties.exists()) {
        ...
        val applicationPackage = "org.devjj.platform.nurbanhoney.${Default.BUILD_FLAVOR}.${Default.BUILD_TYPE}"
        val launchActivity = "org.devjj.platform.nurbanhoney.core.navigation.SplashActivity"
